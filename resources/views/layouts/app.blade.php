            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ Auth::user()->profile_image }}" class="user-image img-circle elevation-2"
                            alt="User Image">
                        <?php } ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer bg-white">
                            <a href="/user/profile" class="btn btn-default btn-flat">Profile <i
                                    class="fas fa-user"></i></a>
                            <a href="/user/update-profile" class="btn btn-default btn-flat">Update Profile <i
                                    class="fas fa-pen"></i></a>
                            <a href="/user/change-password" class="btn btn-default btn-flat">Change Password <i
