...
<head>
    ...
    <title>GHG MONITORING Form</title>
    <style type="text/css">
        @page {
        ...
        <table style="width:90%;">
            <tr>
                <td  style="border:0 !important; text-align:left; padding-left:50px;">
                    <img style="width:80%;" src="data:image/svg+xml;base64,{{ base64_encode(file_get_contents(public_path('images/leadsAgri.png'))) }}"
                alt="Logo">
                </td>
                <td  style="border:0 !important; text-align: right;">
                    <img style="width:20%;" src="data:image/svg+xml;base64,{{ base64_encode(file_get_contents(public_path('images/digisaka_logo.png'))) }}"
                alt="Logo">
                </td>
            </tr>
        </table>
