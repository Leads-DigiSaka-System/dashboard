<div class="tab-pane fade" id="demo5" style="padding-right: 10px;">

            <div class="row">
                <div class="col-md-7">
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <h4 class="mb-1">Corporate Farming</h4>
                            <div id="corporate_map" style="height: 700px; width: 100%;"></div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <figure class="highcharts-figure">
                                <div id="corporate_area_planted"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <figure class="highcharts-figure">
                                <div id="corporate_variety_planted"></div>
                            </figure>
                        </div>
                    </div>
                </div>
