<div class="tab-pane fade" id="demo6" style="padding-right: 10px;">

            <div class="row">
                <div class="col-md-7">
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <h4 class="mb-1">Provincial Rice Techno Forum</h4>
                            <div id="provincial_map" style="height: 700px; width: 100%;"></div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <figure class="highcharts-figure">
                                <div id="provincial_area_planted"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="card rounded-3 shadow-sm">
                        <div class="card-body">
                            <figure class="highcharts-figure">
                                <div id="provincial_variety_planted"></div>
                            </figure>
                        </div>
                    </div>
                </div>
