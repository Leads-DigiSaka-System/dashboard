...
class EmailQueue extends Model
{
    ...
    {
        $columnNumber = isset($request['order'][0]['column'])?$request['order'][0]['column']:"";
        $order = isset($request['order'][0]['dir'])?$request['order'][0]['dir']:"";
    ...
    public static function add($args = []){
        ...
        $mail->from_email = env('MAIL_FROM_ADDRESS','test52352@gmail.com');
